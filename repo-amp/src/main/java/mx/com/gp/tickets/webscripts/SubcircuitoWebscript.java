...
public class SubcircuitoWebscript extends DeclarativeWebScript {
	...
	public static Logger logger = Logger.getLogger(SubcircuitoWebscript.class.getName());

	@Override
	protected Map<String, Object> executeImpl(WebScriptRequest request, Status status){

		System.out.println("Inicia WebScript Subcircuito");

		String modulo = request.getParameter("circuito");
		System.out.println("parametro circuito: "+modulo);

		String fileName = "circuitos/cm:subcircuitos/cm:"+modulo+".list";
		System.out.println("filename: "+fileName);

		String dataResultName = "subcircuitos";
