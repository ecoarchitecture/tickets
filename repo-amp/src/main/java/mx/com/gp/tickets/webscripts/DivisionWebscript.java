...
public class DivisionWebscript extends DeclarativeWebScript {
	...
	public static Logger logger = Logger.getLogger(DivisionWebscript.class.getName());

	@Override
	protected Map<String, Object> executeImpl(WebScriptRequest request, Status status){

		logger.error("Inicia WebScript Divisiones");

		String fileName = "DIVISION.list";
	    String dataResultName = "divisiones";

	    Map<String, Object> model = new ReadDataFile().execute(searchService, contentService, fileName, dataResultName);

	    logger.error("divisiones "+model.get(dataResultName));
