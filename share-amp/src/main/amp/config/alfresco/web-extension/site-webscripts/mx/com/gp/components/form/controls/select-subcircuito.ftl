...
function getSubcircuitoFieldId(){
...
function getValueSubcircuito(){

	console.log("on getValueDetalle");
	console.log("detalleFieldValue "+'${field.value?string}');
	console.log("detalleField "+'${field}');
...
function setValueSubcircuito(element){
